...
var Capres_Alto = new ol.layer.Vector({//
  ...
  name: 'Capres_Alto',
  source: new ol.source.Vector({
              url: '/static/layers/color_capres_alto.geojson',
              format: new ol.format.GeoJSON()
            }),
  style: new ol.style.Style({
...
var Capres_Bajo = new ol.layer.Vector({
  ...
  name: 'Capres_Bajo',
  source: new ol.source.Vector({
              url: '/static/layers/color_capres_bajo.geojson',
              format: new ol.format.GeoJSON()
            }),
  style: new ol.style.Style({
...
var Capres_Medio = new ol.layer.Vector({
  ...
  name: 'Capres_Medio',
  source: new ol.source.Vector({
              url: '/static/layers/color_capres_medio.geojson',
              format: new ol.format.GeoJSON()
            }),
  style: new ol.style.Style({
...
var Capres_Muy_Alto = new ol.layer.Vector({
  ...
  source: new ol.source.Vector({
              url: '/static/layers/color_capres_muy_alto.geojson',
              format: new ol.format.GeoJSON()
            }),
  style: new ol.style.Style({
...
selectedFeatures.clear();
   codigo(Capres_Alto,a)
   codigo(Capres_Bajo,a)
   codigo(Capres_Medio,a)
   codigo(Capres_Muy_Alto,a)
   codigo(Capres_Muy_Bajo,a)
}
...
function dibujar (){
  ...
  evaluar(Capres_Alto,polygon);
  evaluar(Capres_Bajo,polygon);
  evaluar(Capres_Medio,polygon);
  evaluar(Capres_Muy_Alto,polygon);
  evaluar(Capres_Muy_Bajo,polygon);
  });
